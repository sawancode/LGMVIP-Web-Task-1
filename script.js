...
// lets add categproes amd tasls wit js
...
// lets add functionality to add new taks 
...
addBtn.addEventListener("click", () => {
  ...
  if(task === "") {
    alert("Excuse me sawan solanki Please enter a task");
  } else {
    const newTask = {
      id : tasks.length + 1,
      task,
